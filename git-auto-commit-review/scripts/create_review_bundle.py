...
> 规则来源：`.claude/skills/git-auto-commit-review/references/review-rules.md`

## Programmer Decision（必填）

- 采纳建议: 全部 / 部分 / 不采纳
- 采纳列表（逐条列出）:
- 不采纳原因（可选）:

## Applied Changes（可选，用于二次检查）

- 已采纳并完成的修改（逐条列出）:
- 重新跑的测试/验证（命令 + 结果）:
- 二次检查结论（是否可以提交）:

## Commit Message（必填，遵守规范）
